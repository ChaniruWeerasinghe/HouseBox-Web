    ...
    <section class="w-full relative py-24 bg-fixed bg-center bg-cover bg-no-repeat" style="background-image: url('assets/images/home/hero-main.webp');">
        ...
        <div class="max-w-[1400px] mx-auto w-full flex flex-col items-center relative z-10 px-12">
            ...
            <div class="w-full flex items-center justify-between gap-6 relative">
                ...
                <!-- Central Card -->
                <div class="flex-grow bg-transparent rounded-[24px] overflow-hidden flex shadow-2xl h-[460px]">
                    ...
                    <!-- Right: Info Card -->
                    <div class="w-[55%] h-full bg-white p-10 flex flex-col justify-between">
